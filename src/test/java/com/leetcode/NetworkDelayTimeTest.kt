...
import com.leetcode.graph.NetworkDelayTime
...
class NetworkDelayTimeTest {
    ...
    fun networkDelayTime() {
        ...
        assertEquals(70, NetworkDelayTime().networkDelayTime(
                testB.twoPrimitiveArray { it.toInt() }, 15, 2
        ))

        val testA = "[4,2,76],[1,3,79],[3,1,81],[4,3,30],[2,1,47],[1,5,61],[1,4,99],[3,4,68],[3,5,46],[4,1,6],[5,4,7],[5,3,44],[4,5,19],[2,3,13],[3,2,18],[1,2,0],[5,1,25],[2,5,58],[2,4,77],[5,2,74]]"
        assertEquals(59, NetworkDelayTime().networkDelayTime(
                testA.twoPrimitiveArray { s -> s.toInt() }, 5, 3
        ))
        assertEquals(4, NetworkDelayTime().networkDelayTime(arrayOf(
                intArrayOf(2, 5, 4),
                intArrayOf(5, 4, 2),
                intArrayOf(2, 1, 1),
                intArrayOf(2, 3, 1),
                intArrayOf(3, 4, 1)), 5, 2))
        assertEquals(2, NetworkDelayTime().networkDelayTime(arrayOf(
                intArrayOf(2, 1, 1),
                intArrayOf(2, 3, 1),
                intArrayOf(3, 4, 1)), 4, 2))
    }
}